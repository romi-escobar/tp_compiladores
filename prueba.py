#Escribir un Traductor Dirigido por la Sintaxis predictivo que recibe una lista 
# de números binarios y retorna la lista, pero con sus números decimales equivalentes.
